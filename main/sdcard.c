...
// static esp_err_t s_example_read_fd(const char *path)
// {
//     ESP_LOGI(TAG, "Reading file %s using fd API", path);
...
//     }
//     char line[EXAMPLE_MAX_CHAR_SIZE];
//     ssize_t cnt = read(fd, line, sizeof(line) - 1);
//     line[cnt] = 0;
//     close(fd);
...
//     ret = s_example_read_fd(file_foo);
//     // if (ret != ESP_OK) {
//     //     return;
//     // }
